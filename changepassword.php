...
if (isset($_POST['submit'])) {
    ...
    if (strlen($password) < 8) {
        echo "<script>alert('Password must be 8 charachters long','_self')</script>";
    }
    ...
    if ($DB->write($query1, [])) {
      ...
      echo "<script>alert('Something went wrong','_self')</script>";
    }
  }
  else{
            echo "<script>alert('Incorrect OTP','_self')</script>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>My Chat | Change Password</title>
</head>
<style type="text/css">
    @font-face {
...
<body>
    <div id="wrapper">
        <div id="header">My Chat
            <div style="font-size: 20px; font-family:myFont; padding-bottom:10px;">Change Password</div>
        </div>
